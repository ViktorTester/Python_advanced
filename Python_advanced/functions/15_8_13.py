...
result = max(mixed_list, key=lambda x: x if type(x) == int else False)

print(result)

# The mixed_list contains integer and string values.
# The program, using the built-in function max(),
# finds and displays the largest numeric value in the specified list.