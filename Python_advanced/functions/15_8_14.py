...
result = sorted(mixed_list, key=lambda x: (type(x) == str, x))

print(*result)

# The mixed_list contains integer and string values. The program sorts it in
# ascending order of element values, with numbers coming before rows.
# The elements of the sorted list are displayed on one line, separated by a space character.