"""Based on the 'persons' list, the program selects information
about phone numbers and adds them to a separate 'phones' list."""
...
def phone_numbers(s: dict) -> str:
    for key, value in s.items():
        if key == 'phone':
            return value


phones = [i for i in map(phone_numbers, persons)]
