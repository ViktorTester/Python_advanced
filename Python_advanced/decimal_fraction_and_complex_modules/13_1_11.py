...
# Decimal numbers separated by a space character are stored in the string variable s.
# The program displays on the first line the sum of all numbers, and on the second line
# the 5 largest numbers in descending order, separated by a space character.